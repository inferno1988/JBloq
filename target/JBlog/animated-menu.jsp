...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/animated-menu.css"/>
	...
	<script src="${pageContext.request.contextPath}/resources/js/animated-menu.js" type="text/javascript"></script>
</head>
